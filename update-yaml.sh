...
sed -i'' "s@docker.io/[^/]\+/.*@docker.io/${IMAGE_ORG}/config:${IMAGE_VERSION}@g" ${DEPLOY_DIR}/config.yaml
sed -i'' "s@docker.io/[^/]\+/.*@docker.io/${IMAGE_ORG}/eureka:${IMAGE_VERSION}@g" ${DEPLOY_DIR}/eureka.yaml
sed -i'' "s@docker.io/[^/]\+/.*@docker.io/${IMAGE_ORG}/subride-front:${IMAGE_VERSION}@g" ${DEPLOY_DIR}/front.yaml
sed -i'' "s@docker.io/[^/]\+/.*@docker.io/${IMAGE_ORG}/scg:${IMAGE_VERSION}@g" ${DEPLOY_DIR}/scg.yaml
sed -i'' "s@docker.io/[^/]\+/.*@docker.io/${IMAGE_ORG}/subrecommend:${IMAGE_VERSION}@g" ${DEPLOY_DIR}/subrecommend.yaml
